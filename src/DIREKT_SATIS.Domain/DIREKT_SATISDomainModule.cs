...
public class DIREKT_SATISDomainModule : AbpModule
{
        ...
        Configure<NewsletterOptions>(options =>
        {
            options.AddPreference(
                ...
                new NewsletterPreferenceDefinition(
                    LocalizableString.Create<DIREKT_SATISResource>("NewsletterPreference_Default"),
                    privacyPolicyConfirmation: LocalizableString.Create<DIREKT_SATISResource>("NewsletterPrivacyAcceptMessage")
                )
            );
        });
