...
public class DIREKT_SATISDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public DIREKT_SATISDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
