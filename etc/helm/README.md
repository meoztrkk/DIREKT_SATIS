...
```
127.0.0.1 direkt_satis-local-web
127.0.0.1 direkt_satis-local-webgateway
127.0.0.1 direkt_satis-local-authserver
```
...
Now, you can browse the URL: `https://direkt_satis-local-web`
